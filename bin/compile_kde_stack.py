...
SMECH_TARGET = "/mnt/smechos"
SOURCES_DIR = "/tmp/smechos_build/sources"
...
env["PATH"] = f"{SMECH_TARGET}/usr/bin:{env.get('PATH', '')}"
...
modules = [
    ...
    ("karchive", "https://download.kde.org/stable/frameworks/6.6/karchive-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6Archive/KF6ArchiveConfig.cmake"),
    ("kcodecs", "https://download.kde.org/stable/frameworks/6.6/kcodecs-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6Codecs/KF6CodecsConfig.cmake"),
    ("kconfig", "https://download.kde.org/stable/frameworks/6.6/kconfig-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6Config/KF6ConfigConfig.cmake"),
    ("kcoreaddons", "https://download.kde.org/stable/frameworks/6.6/kcoreaddons-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6CoreAddons/KF6CoreAddonsConfig.cmake"),
    ("kdbusaddons", "https://download.kde.org/stable/frameworks/6.6/kdbusaddons-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6DBusAddons/KF6DBusAddonsConfig.cmake"),
    ("kdnssd", "https://download.kde.org/stable/frameworks/6.6/kdnssd-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6DNSSD/KF6DNSSDConfig.cmake"),
    ...
    ("kguiaddons", "https://download.kde.org/stable/frameworks/6.6/kguiaddons-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6GuiAddons/KF6GuiAddonsConfig.cmake"),
    ("ki18n", "https://download.kde.org/stable/frameworks/6.6/ki18n-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6I18n/KF6I18nConfig.cmake"),
    ("kidletime", "https://download.kde.org/stable/frameworks/6.6/kidletime-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6IdleTime/KF6IdleTimeConfig.cmake"),
    ("kitemmodels", "https://download.kde.org/stable/frameworks/6.6/kitemmodels-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6ItemModels/KF6ItemModelsConfig.cmake"),
    ("kitemviews", "https://download.kde.org/stable/frameworks/6.6/kitemviews-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6ItemViews/KF6ItemViewsConfig.cmake"),
    ("kquickcharts", "https://download.kde.org/stable/frameworks/6.6/kquickcharts-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6QuickCharts/KF6QuickChartsConfig.cmake"),
    ("kwindowsystem", "https://download.kde.org/stable/frameworks/6.6/kwindowsystem-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6WindowSystem/KF6WindowSystemConfig.cmake"),
    ("solid", "https://download.kde.org/stable/frameworks/6.6/solid-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6Solid/KF6SolidConfig.cmake"),
    ("sonnet", "https://download.kde.org/stable/frameworks/6.6/sonnet-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6Sonnet/KF6SonnetConfig.cmake"),
    ("threadweaver", "https://download.kde.org/stable/frameworks/6.6/threadweaver-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6ThreadWeaver/KF6ThreadWeaverConfig.cmake"),
    ("prison", "https://download.kde.org/stable/frameworks/6.6/prison-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6Prison/KF6PrisonConfig.cmake"),
    ...
    ("kcolorscheme", "https://download.kde.org/stable/frameworks/6.6/kcolorscheme-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6ColorScheme/KF6ColorSchemeConfig.cmake"),
    ("kwidgetsaddons", "https://download.kde.org/stable/frameworks/6.6/kwidgetsaddons-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6WidgetsAddons/KF6WidgetsAddonsConfig.cmake"),
    ("kcompletion", "https://download.kde.org/stable/frameworks/6.6/kcompletion-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6Completion/KF6CompletionConfig.cmake"),
    ("attica", "https://download.kde.org/stable/frameworks/6.6/attica-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6Attica/KF6AtticaConfig.cmake"),
    ("syntax-highlighting", "https://download.kde.org/stable/frameworks/6.6/syntax-highlighting-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6SyntaxHighlighting/KF6SyntaxHighlightingConfig.cmake"),

    # 3. KF6 Tier 2 Frameworks (Depend only on Tier 1)
    ("kauth", "https://download.kde.org/stable/frameworks/6.6/kauth-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6Auth/KF6AuthConfig.cmake"),
    ("kcrash", "https://download.kde.org/stable/frameworks/6.6/kcrash-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6Crash/KF6CrashConfig.cmake"),
    ("kpackage", "https://download.kde.org/stable/frameworks/6.6/kpackage-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6Package/KF6PackageConfig.cmake"),
    ("kirigami", "https://download.kde.org/stable/frameworks/6.6/kirigami-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6Kirigami/KF6KirigamiConfig.cmake"),
    ("ksvg", "https://download.kde.org/stable/frameworks/6.6/ksvg-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6Svg/KF6SvgConfig.cmake"),
    ("knotifications", "https://download.kde.org/stable/frameworks/6.6/knotifications-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6Notifications/KF6NotificationsConfig.cmake"),
    ("kservice", "https://download.kde.org/stable/frameworks/6.6/kservice-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6Service/KF6ServiceConfig.cmake"),
    ("kjobwidgets", "https://download.kde.org/stable/frameworks/6.6/kjobwidgets-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6JobWidgets/KF6JobWidgetsConfig.cmake"),
    ("kstatusnotifieritem", "https://download.kde.org/stable/frameworks/6.6/kstatusnotifieritem-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6StatusNotifierItem/KF6StatusNotifierItemConfig.cmake"),

    # 4. KF6 Tier 3 Frameworks & Complex Libraries
    ("kconfigwidgets", "https://download.kde.org/stable/frameworks/6.6/kconfigwidgets-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6ConfigWidgets/KF6ConfigWidgetsConfig.cmake"),
    ("kglobalaccel", "https://download.kde.org/stable/frameworks/6.6/kglobalaccel-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6GlobalAccel/KF6GlobalAccelConfig.cmake"),
    ("breeze-icons", "https://download.kde.org/stable/frameworks/6.6/breeze-icons-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6BreezeIcons/KF6BreezeIconsConfig.cmake"),
    ("kiconthemes", "https://download.kde.org/stable/frameworks/6.6/kiconthemes-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6IconThemes/KF6IconThemesConfig.cmake"),
    ("kxmlgui", "https://download.kde.org/stable/frameworks/6.6/kxmlgui-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6XmlGui/KF6XmlGuiConfig.cmake"),
    ("kdeclarative", "https://download.kde.org/stable/frameworks/6.6/kdeclarative-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6Declarative/KF6DeclarativeConfig.cmake"),
    ("kbookmarks", "https://download.kde.org/stable/frameworks/6.6/kbookmarks-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6Bookmarks/KF6BookmarksConfig.cmake"),
    ("ktextwidgets", "https://download.kde.org/stable/frameworks/6.6/ktextwidgets-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6TextWidgets/KF6TextWidgetsConfig.cmake"),
    ...
    ("kio", "https://download.kde.org/stable/frameworks/6.6/kio-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6KIO/KF6KIOConfig.cmake"),
    ("kcmutils", "https://download.kde.org/stable/frameworks/6.6/kcmutils-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6KCMUtils/KF6KCMUtilsConfig.cmake"),
    ("kparts", "https://download.kde.org/stable/frameworks/6.6/kparts-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6Parts/KF6PartsConfig.cmake"),
    ("knotifyconfig", "https://download.kde.org/stable/frameworks/6.6/knotifyconfig-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6NotifyConfig/KF6NotifyConfigConfig.cmake"),
    ("krunner", "https://download.kde.org/stable/frameworks/6.6/krunner-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6Runner/KF6RunnerConfig.cmake"),
    ("knewstuff", "https://download.kde.org/stable/frameworks/6.6/knewstuff-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6NewStuff/KF6NewStuffConfig.cmake"),
    ("kded", "https://download.kde.org/stable/frameworks/6.6/kded-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6KDED/KF6KDEDConfig.cmake"),
    ("kwallet", "https://download.kde.org/stable/frameworks/6.6/kwallet-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6Wallet/KF6WalletConfig.cmake"),
    ("ktexteditor", "https://download.kde.org/stable/frameworks/6.6/ktexteditor-6.6.0.tar.xz", f"{SMECH_TARGET}/usr/lib/cmake/KF6TextEditor/KF6TextEditorConfig.cmake"),
...
for name, url, check_path in modules:
    ...
    if os.path.exists(build_dir):
        ...
        sudo_install_cmd = ["sudo", "-E", "env", f"PATH={env['PATH']}", f"LD_LIBRARY_PATH={env['LD_LIBRARY_PATH']}", f"DESTDIR={SMECH_TARGET}"] + install_cmd
